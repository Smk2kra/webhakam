...
@section('content')
  ...
  <div class="row g-3">
        ...
        <div class="border-bottom">
          <div style="width: 100px; height: 100px;" class="mx-auto rounded-circle overflow-hidden mb-1">
            <img src="http://127.0.0.1:8000/sample-image/guru6.jpg" alt="Guru 6" class="img-fluid">
          </div>
        ...
        <div class="border-bottom">
          <div style="width: 100px; height: 100px;" class="mx-auto rounded-circle overflow-hidden mb-1">
            <img src="http://127.0.0.1:8000/sample-image/guru7.jpg" alt="Guru 7" class="img-fluid">
          </div>
        ...
        <div class="border-bottom">
          <div style="width: 100px; height: 100px;" class="mx-auto rounded-circle overflow-hidden mb-1">
            <img src="http://127.0.0.1:8000/sample-image/guru8.jpg" alt="Guru 8" class="img-fluid">
          </div>
